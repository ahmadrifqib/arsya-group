...
const vueuseHead_c5eb5090 = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "name": "author", "content": "Arsya Group" }, { "name": "keywords", "content": "Arysa, Arsya Group, Arysa Buah, Arsya Catering, Arsya Cafe, Arsya Wisata" }, { "name": "description", "content": "Arsya Group | Harmony Dalam Keselarasan" }, { "property": "og:title", "content": "Arsya Group" }, { "property": "og:site_name", "content": "Arsya Group" }, { "property": "og:description", "content": "Arsya Group | Harmony Dalam Keselarasan" }, { "property": "og:type", "content": "website" }, { "property": "og:url", "content": "https://arsya.co.id/" }, { "name": "twitter:card", "content": "summary" }, { "name": "twitter:title", "content": "Arsya Group" }, { "name": "twitter:description", "content": "Arsya Group | Harmony Dalam Keselarasan" }], "title": "Arsya Group", "link": [{ "rel": "icon", "type": "image/x-icon", "href": "static/favicon.ico" }], "style": [], "script": [] }, "mixinKey": "created" };
const plugin_6f167fac = defineNuxtPlugin((nuxtApp) => {
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
const NUXT_BASE$4 = NUXT_CONFIG.app.cdnURL || NUXT_CONFIG.app.baseURL;
const _imports_0 = joinURL(NUXT_BASE$4, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/logo.d545743f.png".replace("/__NUXT_BASE__", ""));
const NUXT_BASE$3 = NUXT_CONFIG.app.cdnURL || NUXT_CONFIG.app.baseURL;
const _imports_1 = joinURL(NUXT_BASE$3, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/logo-catering.ca1848ce.png".replace("/__NUXT_BASE__", ""));
const NUXT_BASE$2 = NUXT_CONFIG.app.cdnURL || NUXT_CONFIG.app.baseURL;
const _imports_2 = joinURL(NUXT_BASE$2, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/logo-buah.34ff40ba.png".replace("/__NUXT_BASE__", ""));
const NUXT_BASE$1 = NUXT_CONFIG.app.cdnURL || NUXT_CONFIG.app.baseURL;
const _imports_3 = joinURL(NUXT_BASE$1, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/logo-wisata.a7de6fd4.png".replace("/__NUXT_BASE__", ""));
const NUXT_BASE = NUXT_CONFIG.app.cdnURL || NUXT_CONFIG.app.baseURL;
const _imports_4 = joinURL(NUXT_BASE, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/logo-kafe.e56ffd90.png".replace("/__NUXT_BASE__", ""));
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "font-sans antialiased" }, _attrs))}><div class="relative h-screen mx-auto bg-center bg-no-repeat bg-cover bg-food"><div class="flex flex-col items-center justify-between h-screen mx-auto bg-gray-500 abolute bg-opacity-70"><div class="flex items-center justify-between w-full h-20 bg-white"><div class="flex items-center justify-between h-full text-black bg-white md:bg-black md:text-white"><div class="pl-4 pr-2 md:bg-white md:pl-10"><img class="h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="Logo Arsya"></div><div class="p-5 ml-2 text-3xl font-medium md:mr-10">Arsya Group</div></div><a href="" class="hidden px-3 py-1 mx-20 text-2xl font-medium border-red-500 md:block hover:border-b-4 hover:text-green-600">Home</a></div><div class="tracking-wide text-white rounded font-mendium text-8xl md:text-9xl">Coming Soon!</div><div></div></div><div class="flex flex-col items-center justify-between h-auto px-0 py-10 mx-auto font-normal text-white bg-green-600 md:flex-row md:px-24 md:h-28"><div class="mb-5 md:mb-0">\xA9 ${serverRenderer.exports.ssrInterpolate(new Date().getFullYear())} Arsya Group | All rights reserved</div><div class="flex flex-row"><div class="mr-3"><img class="h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="Logo Catering"></div><div class="mr-3"><img class="h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="Logo Buah"></div><div class="mr-3"><img class="h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} alt="Logo Wisata"></div><div class="mr-0"><img class="h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_4)} alt="Logo Kafe"></div></div></div></div></div>`);
}
